...
// CreateYumGroupRepository 创建 Yum 组仓库（Swagger: POST /v1/repositories/yum/group）
// Create Yum group repository (Swagger: POST /v1/repositories/yum/group)
...
// CreateYumHostedRepository 创建 Yum 托管仓库（Swagger: POST /v1/repositories/yum/hosted）
// Create Yum hosted repository (Swagger: POST /v1/repositories/yum/hosted)
...
// CreateYumProxyRepository 创建 Yum 代理仓库（Swagger: POST /v1/repositories/yum/proxy）
// Create Yum proxy repository (Swagger: POST /v1/repositories/yum/proxy)
...
// GetYumGroupRepository 获取 Yum 组仓库详情（Swagger: GET /v1/repositories/yum/group/{name}）
// Get Yum group repository details (Swagger: GET /v1/repositories/yum/group/{name})
...
// GetYumHostedRepository 获取 Yum 托管仓库详情（Swagger: GET /v1/repositories/yum/hosted/{name}）
// Get Yum hosted repository details (Swagger: GET /v1/repositories/yum/hosted/{name})
...
// GetYumProxyRepository 获取 Yum 代理仓库详情（Swagger: GET /v1/repositories/yum/proxy/{name}）
// Get Yum proxy repository details (Swagger: GET /v1/repositories/yum/proxy/{name})
...
// UpdateYumGroupRepository 更新 Yum 组仓库（Swagger: PUT /v1/repositories/yum/group/{name}）
// Update Yum group repository (Swagger: PUT /v1/repositories/yum/group/{name})
...
// UpdateYumHostedRepository 更新 Yum 托管仓库（Swagger: PUT /v1/repositories/yum/hosted/{name}）
// Update Yum hosted repository (Swagger: PUT /v1/repositories/yum/hosted/{name})
...
// UpdateYumProxyRepository 更新 Yum 代理仓库（Swagger: PUT /v1/repositories/yum/proxy/{name}）
// Update Yum proxy repository (Swagger: PUT /v1/repositories/yum/proxy/{name})
